...
class BusinessIntelligenceService
{
    ...
    private function materializedIkssRows(int $year, string $satkerId, int $quarter): array
    {
        ...
        return DB::table('ikss_results as result')
            ...
            ->whereNotNull('result.achievement')
            ->orderBy('ss.urutan')
            ->orderBy('ikss.urutan')
            ->get([
                'result.ikss_id',
